...
void Metronome::mousePressEvent(QMouseEvent *event){
    if(event->button() == Qt::LeftButton){
        ...
        if (isChecked()){
            ...
            disconnect(m_timer, &MicroTimer::tick5, this, m_strong_and_weak_measures[1]);
            disconnect(m_timer, &MicroTimer::tick9, this, m_strong_and_weak_measures[2]);
            disconnect(m_timer, &MicroTimer::tick13, this, m_strong_and_weak_measures[3]);
            setChecked(false);
            setText("▶");
            setStyleSheet(
                "QPushButton {"
            ...
            connect(m_timer, &MicroTimer::tick5, this, m_strong_and_weak_measures[1]);
            connect(m_timer, &MicroTimer::tick9, this, m_strong_and_weak_measures[2]);
            connect(m_timer, &MicroTimer::tick13, this, m_strong_and_weak_measures[3]);
            setChecked(true);
            setStyleSheet(
                "QPushButton {"
