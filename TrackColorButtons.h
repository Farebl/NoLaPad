...
public:
    explicit TrackColorButtons(uint size = 100, const QColor& outer_background_color = Qt::gray, const QColor& inner_background_color = Qt::darkGray, QWidget *parent = nullptr);
